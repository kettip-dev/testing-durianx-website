    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 w-full py-10">
      {FeedbackItem.map((item, index) => (
        <ComponentTransition
          delay={index * 0.2}
          key={index}
          className="flex bg-neutral-50 dark:bg-neutral-950 border-[1px] relative group z-[9]  hover:lg:border-primary-500 overflow-hidden rounded-3xl flex-col items-start text-start p-6"
        >
