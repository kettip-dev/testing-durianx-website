...
export const CardItem = [
    {
        img: '/img1.png',
        title: "Cambodia's Super-App",
        content: "DurianX is built to empower your everyday life by providing all essential services in one simple, easy-to-use application."
    },
    {
        img: '/img.png',
